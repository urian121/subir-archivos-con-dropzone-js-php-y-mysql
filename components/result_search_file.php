        ...
        <div class="card h-100">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="fileMenu<?php echo $archivo['id_drive']; ?>">
                    ...
                    <li>
                        <a class="dropdown-item eliminar-archivo" onclick="sendFileTrash('<?php echo $archivo['id_drive']; ?>', '<?php echo $archivo['nombre_original']; ?>')" href="#" data-id="<?php echo $archivo['id_drive']; ?>"
