<div class="drive-header border-bottom shadow-sm">
    <div class="d-flex align-items-center px-3 h-100">
        ...
        <div class="d-flex align-items-center me-4">
            <a href="index.php" class="text-decoration-none">
                <img src="assets/imgs/dirve-edumetric.png" alt="driver edumetrisc" style="width: 50px; padding: 5px">
                <span class="fw-normal fs-5">Edumetrics Drive</span>
            </a>
        </div>
